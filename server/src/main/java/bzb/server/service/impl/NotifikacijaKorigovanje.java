...
@Component
public class NotifikacijaKorigovanje implements JavaDelegate {
    ...
    public void execute(DelegateExecution execution) throws Exception {
        ...
        try{
            ...
            msg.setText("Obavestavamo vas da Treba da korigujete rad: " + naslov);
            javaMailSender.send(msg);
            System.out.println("Notifikacija Korigovanje poslata");
